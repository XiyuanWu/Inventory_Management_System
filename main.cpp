...
int main() {
    ...
    store.addProduct(Inventory(1, string("Apple"), 10, 5.0, string("Fruit"), true));
    store.addProduct(Inventory(2, string("Beef"), 5, 20.0, string("Meat"), true));
    store.addProduct(Inventory(3, string("Fish"), 20, 15.0, string("Seafood"), true));
